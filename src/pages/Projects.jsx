...
import { Project1, Project10, Project11, Project12, Project13, Project14, Project15, Project16, Project17, Project18, Project19, Project2, Project20, Project21, Project22, Project23, Project24, Project25, Project26, Project27, Project3, Project4, Project5, Project6, Project7, Project8, Project9 } from '../assets/index'
    ...
    return (
        <section className='px-4 pt-24 pb-7 bg-secondary max-w-6xl mx-auto'>
            ...
            <div className='flex flex-col lg:grid lg:grid-cols-2 lg:gap-3'>
                ...
                <ProjectCard image={Project27} title="MAMA Language" link="/" />
            </div>
        </section>
    )
}
